...
import CRBasicInfo from './CRBasicInfo'
import CRConstraintInfo from './CRConstraintInfo'
import CRComputeInfo from './CRComputeInfo'
import CustomizeInfo from './CustomizeInfo'

const panes = [
    { menuItem: '描述', render: () => <Tab.Pane ><CRBasicInfo/></Tab.Pane> },
    { menuItem: '计算', render: () => <Tab.Pane ><CRComputeInfo/></Tab.Pane> },
    { menuItem: '约束', render: () => <Tab.Pane><CRConstraintInfo/></Tab.Pane> },
    { menuItem: '自定义', render: () => <Tab.Pane><CustomizeInfo/></Tab.Pane> }
]

const CRFormEdit = () =>( <Tab panes={panes} />)

export default CRFormEdit
