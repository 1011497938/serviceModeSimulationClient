...
export default class Controller extends GraphController {
  constructor(diagram, palette) {
    ...
    this.palNodeTemplateMap.add('carrier', carrierNodeTemplateForPallete)
    this.palNodeTemplateMap.add('resource', resourceNodeTemplateForPallete)
...
const carrierNodeTemplateForPallete = genForPalette(
  $(go.Panel, "Auto",
    // this rectangular shape surrounds the content of the node
    $(go.Shape,
      { fill: "#EEEEEE" ,stroke: null,}),
      ...
      $(go.Panel, "Table",
        {
          ...
          defaultStretch: go.GraphObject.Horizontal,
          itemTemplate: fieldTemplate,
          itemArray: [{ name: "field", info: "value", color: "#F7B84B", figure: "Ellipse" },],
        },
      )  // end Table Panel of items
    ),  // end Vertical Panel
  ),  // end Node
