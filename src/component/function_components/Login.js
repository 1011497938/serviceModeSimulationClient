 					...
 					<div className='loginBox'>
 						   ...
 						   <Form style={{width:'60%',margin:'0 auto'}}>
				              ...
				              <div style={{display:'flex',justifyContent:'space-between',color:"#666",padding:5}}>
				                   ...
				                   <span style={{cursor:'pointer'}} onClick={()=>{window.location.href="http://localhost:3000/rigister"}}>注册</span>
				              </div>
				                <div>
				                  <Button style={{marginBottom:10,marginTop:30}}  fluid  color='grey' onClick={()=>{window.location.href="http://localhost:3000/center"}}>提&nbsp;交</Button>
